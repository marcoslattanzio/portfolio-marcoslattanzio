...
export const SITE_PATH = "data/site.json";
...
// Lee un JSON tal y como está AHORA en GitHub. Importante: el que viene
// compilado en la web es el del último despliegue, así que si publicas dos
// veces seguidas sin esperar a Vercel, partir del bundle pisaría lo anterior.
// Aquí siempre se parte de la verdad del repositorio.
...
export const fetchProjects = (token) => fetchJson(token, PROJECTS_PATH);
export const fetchSite = (token) => fetchJson(token, SITE_PATH);
